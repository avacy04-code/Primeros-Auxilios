...
const preguntas = [
  {
    ...
    respuestas: ["Sustituir al médico", "Impedir que el herido empeore y mantener sus constantes", "Curar completamente a la víctima", "Trasladar siempre al herido"],
    correcta: 1,
  ...
  },
  {
    ...
    respuestas: ["Mover rápido a todos los heridos", "Comprobar si el lugar es seguro", "Dar agua a las víctimas", "Quitar el casco a un motorista"],
    correcta: 1,
    imagen: "img/botiquin.jpg",
    categoria: "Seguridad"
  },
  {
    ...
    respuestas: ["Mover a la persona cuanto antes", "Sentarla", "Evitar moverla", "Levantarla entre varios"],
    correcta: 2,
  ...
  },
  {
    ...
    respuestas: ["Llamar al 112", "Señalizar la zona", "Quitar el casco", "Hablar con la víctima"],
    correcta: 2,
    imagen: "img/fractura.jpg",
    categoria: "Traumatismos"
  },
  {
    ...
    respuestas: ["Dar agua y comida", "Dar café", "No dar agua ni comida", "Dar alcohol para animar"],
    correcta: 2,
  ...
  },
  {
    ...
    respuestas: ["Intentar recolocar el hueso", "Inmovilizar y llevar al médico", "Masajear la zona", "Hacer que camine"],
    correcta: 1,
    imagen: "img/fractura.jpg",
    categoria: "Traumatismos"
  },
  {
    ...
    respuestas: ["Siempre que haya una herida", "Solo en casos extremos", "En cualquier corte pequeño", "Antes de limpiar una herida"],
    correcta: 1,
  ...
  },
  {
    ...
    respuestas: ["Boca arriba", "Posición lateral de seguridad", "Sentada", "De pie"],
    correcta: 1,
    imagen: "img/pls.jpg",
    categoria: "Emergencias"
  },
  {
    ...
    respuestas: ["Picor leve", "Hemorragia severa", "Rozadura pequeña", "Ampolla cerrada"],
    correcta: 1,
    imagen: "img/hemorragia.jpg",
    categoria: "Emergencias"
  },
  {
    ...
    respuestas: ["Alarma", "Asfixia", "Estado de conciencia", "Nada, la A no existe"],
    correcta: 2,
    imagen: "img/rcp.jpg",
  ...
  },
  {
    ...
    respuestas: ["Ventilación y vía aérea", "Botiquín", "Brazo lesionado", "Bebida"],
    correcta: 0,
    imagen: "img/rcp.jpg",
    categoria: "Valoración primaria"
  },
  {
    ...
    respuestas: ["Cabeza", "Circulación y hemorragias agudas", "Columna", "Calambres"],
    correcta: 1,
    imagen: "img/hemorragia.jpg",
    categoria: "Valoración primaria"
  },
  {
    ...
    respuestas: ["Sucio para usarlo rápido", "Fuera del alcance de los niños y bien identificado", "Abierto siempre", "Solo en el coche"],
    correcta: 1,
    imagen: "img/botiquin.jpg",
    categoria: "Botiquín"
  },
  {
    ...
    respuestas: ["Aplicar pasta de dientes", "Pedir ayuda", "Valorar la gravedad", "Actuar con calma"],
    correcta: 0,
  ...
  },
  {
    ...
    respuestas: ["Dejar el apósito", "Cambiar continuamente el apósito lleno de sangre", "Presionar la herida", "Pedir ayuda"],
    correcta: 1,
    imagen: "img/hemorragia.jpg",
    categoria: "Hemorragias"
  },
  {
    ...
    respuestas: ["Aplicar la maniobra de Heimlich si procede", "Dar 3 o 4 golpes secos entre los omóplatos como única actuación", "Pedir ayuda", "Actuar rápido"],
    correcta: 1,
    imagen: "img/112.jpg",
  ...
  },
  {
    ...
    respuestas: ["Aplicar hielo protegido", "Aplicar calor directo", "Seguir haciendo ejercicio", "Masajear fuerte"],
    correcta: 0,
  ...
  },
  {
    ...
    respuestas: ["Mover mucho la zona", "Aplicar hielo y no mover la zona", "Dar calor inmediato", "Correr despacio"],
    correcta: 1,
    imagen: "img/esguince.jpg",
    categoria: "Traumatismos"
  },
  {
    ...
    respuestas: ["Alcohol directamente", "Agua y jabón", "Vinagre", "Perfume"],
    correcta: 1,
    imagen: "img/herida.jpg",
    categoria: "Heridas"
  },
  ...
  },
  {
    ...
    respuestas: ["Aplicar frío", "Inclinar la cabeza hacia atrás", "Presionar la zona", "Pedir ayuda si no cede"],
    correcta: 1,
    imagen: "img/hemorragia.jpg",
    categoria: "Hemorragias"
  },
  {
    ...
    respuestas: ["Romperla siempre", "Nunca romperla si no es necesario", "Aplicar alcohol puro", "Quitar toda la piel"],
    correcta: 1,
    imagen: "img/herida.jpg",
  ...
  },
  {
    ...
    respuestas: ["Seguir al sol", "Beber y retirarse del sol", "No beber nada", "Ponerse más ropa"],
    correcta: 1,
    imagen: "img/botiquin.jpg",
  ...
  },
  {
    ...
    respuestas: ["Sueño", "Líquido y sales minerales", "Ropa adecuada", "Descanso nocturno"],
    correcta: 1,
    imagen: "img/esguince.jpg",
    categoria: "Calambres"
  },
  {
    ...
    respuestas: ["Poner a la persona de pie", "Tumbarla y elevar las piernas", "Hacerla correr", "Dar golpes en la espalda"],
    correcta: 1,
    imagen: "img/botiquin.jpg",
    categoria: "Desmayos"
  },
  {
    ...
    respuestas: ["Seguir haciendo ejercicio", "Retirarse del sol, beber y refrescar cabeza y cuello", "Taparse más", "No beber agua"],
    correcta: 1,
    imagen: "img/quemadura.jpg",
  ...
  },
  {
    ...
    respuestas: ["Sujetar con fuerza a la persona", "Poner algo en la boca", "Retirar objetos peligrosos de alrededor", "Dar agua"],
    correcta: 2,
  ...
  },
  {
    ...
    respuestas: ["Extraer el aguijón cuanto antes", "Chupar la herida", "Frotar con tierra", "Pinchar más la zona"],
    correcta: 0,
    imagen: "img/herida.jpg",
    categoria: "Picaduras"
  },
  {
    ...
    respuestas: ["Pedir ayuda", "Evitar que el herido se mueva mucho", "Chupar la herida", "Mantener la calma"],
    correcta: 2,
    imagen: "img/herida.jpg",
    categoria: "Picaduras"
  },
  {
    ...
    respuestas: ["Hemorragia nasal", "Atragantamiento", "Esguince", "Ampolla"],
    correcta: 1,
    imagen: "img/112.jpg",
    categoria: "Obstrucción respiratoria"
  },
  {
    ...
    respuestas: ["No calentar nunca", "Usar cualquier calzado", "Calentar y estirar adecuadamente", "Entrenar con dolor"],
    correcta: 2,
    imagen: "img/esguince.jpg",
